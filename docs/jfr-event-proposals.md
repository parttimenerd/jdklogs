...
**Last updated**: 2026-08-18 (pass 52)
...
- `exceededGoal=true` with `threadsWanted < G1ConcRefinementThreads` → increase `-XX:G1ConcRefinementThreads` to give the policy more threads to allocate.
