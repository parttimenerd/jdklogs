...
**Last updated**: 2026-08-18 (pass 41)
...
3. G1 concurrent refinement context: does upstream want a note in the JFR RFE linking this event to the ongoing refinement redesign observability gap?
...
| Field | Source | Nullable? | Tuning use |
|---|---|---|---|
| `startTime` | Standard JFR | No | Timestamp of periodic refinement policy evaluation; correlate with nearby `jdk.GarbageCollection` events to see the policy state at GC pause boundaries |
