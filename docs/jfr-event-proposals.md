...
**Last updated**: 2026-08-18 (pass 51)
...
- Trim frequency tuning: if `deltaBytes` is near 0 after every trim, the interval can be increased (less overhead); if `deltaBytes` is large on every trim, decrease the interval.
